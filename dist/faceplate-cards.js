var he=Object.defineProperty;var ci=Object.getOwnPropertyDescriptor;var k=(s,i)=>()=>(s&&(i=s(s=0)),i);var pi=(s,i)=>{for(var t in i)he(s,t,{get:i[t],enumerable:!0})};var d=(s,i,t,e)=>{for(var n=e>1?void 0:e?ci(i,t):i,o=s.length-1,a;o>=0;o--)(a=s[o])&&(n=(e?a(i,t,n):a(n))||n);return e&&n&&he(i,t,n),n};function Vt(s){let i=s.toLowerCase();return i.includes("auto")?"mdi:fan-auto":i==="off"?"mdi:fan-off":/(quiet|silent|sleep|night)/.test(i)?"mdi:fan-minus":/(low|min|1)/.test(i)?"mdi:fan-speed-1":/(mid|med|2)/.test(i)?"mdi:fan-speed-2":/(high|3)/.test(i)?"mdi:fan-speed-3":/(max|top|turbo|strong|4|5)/.test(i)?"mdi:fan-plus":"mdi:fan"}function Wt(s){let i=s.trim();return/^\d+$/.test(i)?i:/^auto(matic)?$/i.test(i)?"auto":null}function $t(s,i){let t=s.toLowerCase();return/(off|stop|fix)/.test(t)?i?"mdi:pan-horizontal":"mdi:pan-vertical":/(on|swing|both|all|auto|oscillat|full|range)/.test(t)?i?"mdi:swap-horizontal":"mdi:swap-vertical":i?/left/.test(t)?"mdi:arrow-left":/right/.test(t)?"mdi:arrow-right":/(mid|cent)/.test(t)?"mdi:arrow-split-vertical":"mdi:swap-horizontal":/(highest|top|up)/.test(t)?"mdi:arrow-up":/(lowest|bottom|down|low)/.test(t)?"mdi:arrow-down":/(mid|cent|horiz)/.test(t)?"mdi:arrow-split-horizontal":/high/.test(t)?"mdi:arrow-top-right":"mdi:swap-vertical"}function ue(s){let i=s.toLowerCase();return/both|all/.test(i)?"mdi:arrow-all":/horiz/.test(i)?"mdi:swap-horizontal":/vert/.test(i)?"mdi:swap-vertical":/off|stop|fix/.test(i)?"mdi:arrow-oscillating-off":"mdi:arrow-oscillating"}function P(s){return s.replace(/[_-]+/g," ").replace(/\b\w/g,i=>i.toUpperCase())}function Gt(s){return/^auto/i.test(s.replace(/[_\s-]+/g,""))?"":P(s)}var vt,xt,qt,ht,X,kt=k(()=>{"use strict";vt="faceplate-climate-card",xt="faceplate-climate-card-editor",qt=["off","auto","heat_cool","heat","cool","dry","fan_only"],ht={auto:"mdi:thermostat-auto",heat_cool:"mdi:sun-snowflake-variant",heat:"mdi:fire",cool:"mdi:snowflake",dry:"mdi:water-percent",fan_only:"mdi:fan",off:"mdi:power"},X={auto:"var(--state-climate-auto-color, #008e6d)",heat_cool:"var(--state-climate-heat_cool-color, #008e6d)",heat:"var(--state-climate-heat-color, #ff8100)",cool:"var(--state-climate-cool-color, #2196f3)",dry:"var(--state-climate-dry-color, #efbd07)",fan_only:"var(--state-climate-fan_only-color, #009688)",off:"var(--state-climate-off-color, var(--disabled-text-color, #9e9e9e))"}});var At,St,Kt,me,dt,fe,g,ge,Zt,Yt=k(()=>{At=globalThis,St=At.ShadowRoot&&(At.ShadyCSS===void 0||At.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Kt=Symbol(),me=new WeakMap,dt=class{constructor(i,t,e){if(this._$cssResult$=!0,e!==Kt)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=i,this.t=t}get styleSheet(){let i=this.o,t=this.t;if(St&&i===void 0){let e=t!==void 0&&t.length===1;e&&(i=me.get(t)),i===void 0&&((this.o=i=new CSSStyleSheet).replaceSync(this.cssText),e&&me.set(t,i))}return i}toString(){return this.cssText}},fe=s=>new dt(typeof s=="string"?s:s+"",void 0,Kt),g=(s,...i)=>{let t=s.length===1?s[0]:i.reduce((e,n,o)=>e+(a=>{if(a._$cssResult$===!0)return a.cssText;if(typeof a=="number")return a;throw Error("Value passed to 'css' function must be a 'css' function result: "+a+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(n)+s[o+1],s[0]);return new dt(t,s,Kt)},ge=(s,i)=>{if(St)s.adoptedStyleSheets=i.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let t of i){let e=document.createElement("style"),n=At.litNonce;n!==void 0&&e.setAttribute("nonce",n),e.textContent=t.cssText,s.appendChild(e)}},Zt=St?s=>s:s=>s instanceof CSSStyleSheet?(i=>{let t="";for(let e of i.cssRules)t+=e.cssText;return fe(t)})(s):s});var di,ui,mi,fi,gi,_i,Et,_e,bi,wi,ut,mt,Tt,be,I,ft=k(()=>{Yt();Yt();({is:di,defineProperty:ui,getOwnPropertyDescriptor:mi,getOwnPropertyNames:fi,getOwnPropertySymbols:gi,getPrototypeOf:_i}=Object),Et=globalThis,_e=Et.trustedTypes,bi=_e?_e.emptyScript:"",wi=Et.reactiveElementPolyfillSupport,ut=(s,i)=>s,mt={toAttribute(s,i){switch(i){case Boolean:s=s?bi:null;break;case Object:case Array:s=s==null?s:JSON.stringify(s)}return s},fromAttribute(s,i){let t=s;switch(i){case Boolean:t=s!==null;break;case Number:t=s===null?null:Number(s);break;case Object:case Array:try{t=JSON.parse(s)}catch{t=null}}return t}},Tt=(s,i)=>!di(s,i),be={attribute:!0,type:String,converter:mt,reflect:!1,useDefault:!1,hasChanged:Tt};Symbol.metadata??=Symbol("metadata"),Et.litPropertyMetadata??=new WeakMap;I=class extends HTMLElement{static addInitializer(i){this._$Ei(),(this.l??=[]).push(i)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(i,t=be){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(i)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(i,t),!t.noAccessor){let e=Symbol(),n=this.getPropertyDescriptor(i,e,t);n!==void 0&&ui(this.prototype,i,n)}}static getPropertyDescriptor(i,t,e){let{get:n,set:o}=mi(this.prototype,i)??{get(){return this[t]},set(a){this[t]=a}};return{get:n,set(a){let l=n?.call(this);o?.call(this,a),this.requestUpdate(i,l,e)},configurable:!0,enumerable:!0}}static getPropertyOptions(i){return this.elementProperties.get(i)??be}static _$Ei(){if(this.hasOwnProperty(ut("elementProperties")))return;let i=_i(this);i.finalize(),i.l!==void 0&&(this.l=[...i.l]),this.elementProperties=new Map(i.elementProperties)}static finalize(){if(this.hasOwnProperty(ut("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(ut("properties"))){let t=this.properties,e=[...fi(t),...gi(t)];for(let n of e)this.createProperty(n,t[n])}let i=this[Symbol.metadata];if(i!==null){let t=litPropertyMetadata.get(i);if(t!==void 0)for(let[e,n]of t)this.elementProperties.set(e,n)}this._$Eh=new Map;for(let[t,e]of this.elementProperties){let n=this._$Eu(t,e);n!==void 0&&this._$Eh.set(n,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(i){let t=[];if(Array.isArray(i)){let e=new Set(i.flat(1/0).reverse());for(let n of e)t.unshift(Zt(n))}else i!==void 0&&t.push(Zt(i));return t}static _$Eu(i,t){let e=t.attribute;return e===!1?void 0:typeof e=="string"?e:typeof i=="string"?i.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(i=>this.enableUpdating=i),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(i=>i(this))}addController(i){(this._$EO??=new Set).add(i),this.renderRoot!==void 0&&this.isConnected&&i.hostConnected?.()}removeController(i){this._$EO?.delete(i)}_$E_(){let i=new Map,t=this.constructor.elementProperties;for(let e of t.keys())this.hasOwnProperty(e)&&(i.set(e,this[e]),delete this[e]);i.size>0&&(this._$Ep=i)}createRenderRoot(){let i=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return ge(i,this.constructor.elementStyles),i}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(i=>i.hostConnected?.())}enableUpdating(i){}disconnectedCallback(){this._$EO?.forEach(i=>i.hostDisconnected?.())}attributeChangedCallback(i,t,e){this._$AK(i,e)}_$ET(i,t){let e=this.constructor.elementProperties.get(i),n=this.constructor._$Eu(i,e);if(n!==void 0&&e.reflect===!0){let o=(e.converter?.toAttribute!==void 0?e.converter:mt).toAttribute(t,e.type);this._$Em=i,o==null?this.removeAttribute(n):this.setAttribute(n,o),this._$Em=null}}_$AK(i,t){let e=this.constructor,n=e._$Eh.get(i);if(n!==void 0&&this._$Em!==n){let o=e.getPropertyOptions(n),a=typeof o.converter=="function"?{fromAttribute:o.converter}:o.converter?.fromAttribute!==void 0?o.converter:mt;this._$Em=n;let l=a.fromAttribute(t,o.type);this[n]=l??this._$Ej?.get(n)??l,this._$Em=null}}requestUpdate(i,t,e,n=!1,o){if(i!==void 0){let a=this.constructor;if(n===!1&&(o=this[i]),e??=a.getPropertyOptions(i),!((e.hasChanged??Tt)(o,t)||e.useDefault&&e.reflect&&o===this._$Ej?.get(i)&&!this.hasAttribute(a._$Eu(i,e))))return;this.C(i,t,e)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(i,t,{useDefault:e,reflect:n,wrapped:o},a){e&&!(this._$Ej??=new Map).has(i)&&(this._$Ej.set(i,a??t??this[i]),o!==!0||a!==void 0)||(this._$AL.has(i)||(this.hasUpdated||e||(t=void 0),this._$AL.set(i,t)),n===!0&&this._$Em!==i&&(this._$Eq??=new Set).add(i))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}let i=this.scheduleUpdate();return i!=null&&await i,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[n,o]of this._$Ep)this[n]=o;this._$Ep=void 0}let e=this.constructor.elementProperties;if(e.size>0)for(let[n,o]of e){let{wrapped:a}=o,l=this[n];a!==!0||this._$AL.has(n)||l===void 0||this.C(n,void 0,o,l)}}let i=!1,t=this._$AL;try{i=this.shouldUpdate(t),i?(this.willUpdate(t),this._$EO?.forEach(e=>e.hostUpdate?.()),this.update(t)):this._$EM()}catch(e){throw i=!1,this._$EM(),e}i&&this._$AE(t)}willUpdate(i){}_$AE(i){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(i)),this.updated(i)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(i){return!0}update(i){this._$Eq&&=this._$Eq.forEach(t=>this._$ET(t,this[t])),this._$EM()}updated(i){}firstUpdated(i){}};I.elementStyles=[],I.shadowRootOptions={mode:"open"},I[ut("elementProperties")]=new Map,I[ut("finalized")]=new Map,wi?.({ReactiveElement:I}),(Et.reactiveElementVersions??=[]).push("2.1.2")});function Ce(s,i){if(!oe(s)||!s.hasOwnProperty("raw"))throw Error("invalid template strings array");return ye!==void 0?ye.createHTML(i):i}function J(s,i,t=s,e){if(i===O)return i;let n=e!==void 0?t._$Co?.[e]:t._$Cl,o=bt(i)?void 0:i._$litDirective$;return n?.constructor!==o&&(n?._$AO?.(!1),o===void 0?n=void 0:(n=new o(s),n._$AT(s,t,e)),e!==void 0?(t._$Co??=[])[e]=n:t._$Cl=n),n!==void 0&&(i=J(s,n._$AS(s,i.values),n,e)),i}var ne,we,Ct,ye,Se,B,Ee,yi,G,_t,bt,oe,vi,Xt,gt,ve,xe,V,$e,ke,Te,se,r,en,nn,O,c,Ae,W,xi,wt,Jt,yt,Q,Qt,te,ee,ie,$i,ze,tt=k(()=>{ne=globalThis,we=s=>s,Ct=ne.trustedTypes,ye=Ct?Ct.createPolicy("lit-html",{createHTML:s=>s}):void 0,Se="$lit$",B=`lit$${Math.random().toFixed(9).slice(2)}$`,Ee="?"+B,yi=`<${Ee}>`,G=document,_t=()=>G.createComment(""),bt=s=>s===null||typeof s!="object"&&typeof s!="function",oe=Array.isArray,vi=s=>oe(s)||typeof s?.[Symbol.iterator]=="function",Xt=`[ 	
\f\r]`,gt=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,ve=/-->/g,xe=/>/g,V=RegExp(`>|${Xt}(?:([^\\s"'>=/]+)(${Xt}*=${Xt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),$e=/'/g,ke=/"/g,Te=/^(?:script|style|textarea|title)$/i,se=s=>(i,...t)=>({_$litType$:s,strings:i,values:t}),r=se(1),en=se(2),nn=se(3),O=Symbol.for("lit-noChange"),c=Symbol.for("lit-nothing"),Ae=new WeakMap,W=G.createTreeWalker(G,129);xi=(s,i)=>{let t=s.length-1,e=[],n,o=i===2?"<svg>":i===3?"<math>":"",a=gt;for(let l=0;l<t;l++){let p=s[l],m,h,u=-1,b=0;for(;b<p.length&&(a.lastIndex=b,h=a.exec(p),h!==null);)b=a.lastIndex,a===gt?h[1]==="!--"?a=ve:h[1]!==void 0?a=xe:h[2]!==void 0?(Te.test(h[2])&&(n=RegExp("</"+h[2],"g")),a=V):h[3]!==void 0&&(a=V):a===V?h[0]===">"?(a=n??gt,u=-1):h[1]===void 0?u=-2:(u=a.lastIndex-h[2].length,m=h[1],a=h[3]===void 0?V:h[3]==='"'?ke:$e):a===ke||a===$e?a=V:a===ve||a===xe?a=gt:(a=V,n=void 0);let w=a===V&&s[l+1].startsWith("/>")?" ":"";o+=a===gt?p+yi:u>=0?(e.push(m),p.slice(0,u)+Se+p.slice(u)+B+w):p+B+(u===-2?l:w)}return[Ce(s,o+(s[t]||"<?>")+(i===2?"</svg>":i===3?"</math>":"")),e]},wt=class s{constructor({strings:i,_$litType$:t},e){let n;this.parts=[];let o=0,a=0,l=i.length-1,p=this.parts,[m,h]=xi(i,t);if(this.el=s.createElement(m,e),W.currentNode=this.el.content,t===2||t===3){let u=this.el.content.firstChild;u.replaceWith(...u.childNodes)}for(;(n=W.nextNode())!==null&&p.length<l;){if(n.nodeType===1){if(n.hasAttributes())for(let u of n.getAttributeNames())if(u.endsWith(Se)){let b=h[a++],w=n.getAttribute(u).split(B),L=/([.?@])?(.*)/.exec(b);p.push({type:1,index:o,name:L[2],strings:w,ctor:L[1]==="."?Qt:L[1]==="?"?te:L[1]==="@"?ee:Q}),n.removeAttribute(u)}else u.startsWith(B)&&(p.push({type:6,index:o}),n.removeAttribute(u));if(Te.test(n.tagName)){let u=n.textContent.split(B),b=u.length-1;if(b>0){n.textContent=Ct?Ct.emptyScript:"";for(let w=0;w<b;w++)n.append(u[w],_t()),W.nextNode(),p.push({type:2,index:++o});n.append(u[b],_t())}}}else if(n.nodeType===8)if(n.data===Ee)p.push({type:2,index:o});else{let u=-1;for(;(u=n.data.indexOf(B,u+1))!==-1;)p.push({type:7,index:o}),u+=B.length-1}o++}}static createElement(i,t){let e=G.createElement("template");return e.innerHTML=i,e}};Jt=class{constructor(i,t){this._$AV=[],this._$AN=void 0,this._$AD=i,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(i){let{el:{content:t},parts:e}=this._$AD,n=(i?.creationScope??G).importNode(t,!0);W.currentNode=n;let o=W.nextNode(),a=0,l=0,p=e[0];for(;p!==void 0;){if(a===p.index){let m;p.type===2?m=new yt(o,o.nextSibling,this,i):p.type===1?m=new p.ctor(o,p.name,p.strings,this,i):p.type===6&&(m=new ie(o,this,i)),this._$AV.push(m),p=e[++l]}a!==p?.index&&(o=W.nextNode(),a++)}return W.currentNode=G,n}p(i){let t=0;for(let e of this._$AV)e!==void 0&&(e.strings!==void 0?(e._$AI(i,e,t),t+=e.strings.length-2):e._$AI(i[t])),t++}},yt=class s{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(i,t,e,n){this.type=2,this._$AH=c,this._$AN=void 0,this._$AA=i,this._$AB=t,this._$AM=e,this.options=n,this._$Cv=n?.isConnected??!0}get parentNode(){let i=this._$AA.parentNode,t=this._$AM;return t!==void 0&&i?.nodeType===11&&(i=t.parentNode),i}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(i,t=this){i=J(this,i,t),bt(i)?i===c||i==null||i===""?(this._$AH!==c&&this._$AR(),this._$AH=c):i!==this._$AH&&i!==O&&this._(i):i._$litType$!==void 0?this.$(i):i.nodeType!==void 0?this.T(i):vi(i)?this.k(i):this._(i)}O(i){return this._$AA.parentNode.insertBefore(i,this._$AB)}T(i){this._$AH!==i&&(this._$AR(),this._$AH=this.O(i))}_(i){this._$AH!==c&&bt(this._$AH)?this._$AA.nextSibling.data=i:this.T(G.createTextNode(i)),this._$AH=i}$(i){let{values:t,_$litType$:e}=i,n=typeof e=="number"?this._$AC(i):(e.el===void 0&&(e.el=wt.createElement(Ce(e.h,e.h[0]),this.options)),e);if(this._$AH?._$AD===n)this._$AH.p(t);else{let o=new Jt(n,this),a=o.u(this.options);o.p(t),this.T(a),this._$AH=o}}_$AC(i){let t=Ae.get(i.strings);return t===void 0&&Ae.set(i.strings,t=new wt(i)),t}k(i){oe(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,e,n=0;for(let o of i)n===t.length?t.push(e=new s(this.O(_t()),this.O(_t()),this,this.options)):e=t[n],e._$AI(o),n++;n<t.length&&(this._$AR(e&&e._$AB.nextSibling,n),t.length=n)}_$AR(i=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);i!==this._$AB;){let e=we(i).nextSibling;we(i).remove(),i=e}}setConnected(i){this._$AM===void 0&&(this._$Cv=i,this._$AP?.(i))}},Q=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(i,t,e,n,o){this.type=1,this._$AH=c,this._$AN=void 0,this.element=i,this.name=t,this._$AM=n,this.options=o,e.length>2||e[0]!==""||e[1]!==""?(this._$AH=Array(e.length-1).fill(new String),this.strings=e):this._$AH=c}_$AI(i,t=this,e,n){let o=this.strings,a=!1;if(o===void 0)i=J(this,i,t,0),a=!bt(i)||i!==this._$AH&&i!==O,a&&(this._$AH=i);else{let l=i,p,m;for(i=o[0],p=0;p<o.length-1;p++)m=J(this,l[e+p],t,p),m===O&&(m=this._$AH[p]),a||=!bt(m)||m!==this._$AH[p],m===c?i=c:i!==c&&(i+=(m??"")+o[p+1]),this._$AH[p]=m}a&&!n&&this.j(i)}j(i){i===c?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,i??"")}},Qt=class extends Q{constructor(){super(...arguments),this.type=3}j(i){this.element[this.name]=i===c?void 0:i}},te=class extends Q{constructor(){super(...arguments),this.type=4}j(i){this.element.toggleAttribute(this.name,!!i&&i!==c)}},ee=class extends Q{constructor(i,t,e,n,o){super(i,t,e,n,o),this.type=5}_$AI(i,t=this){if((i=J(this,i,t,0)??c)===O)return;let e=this._$AH,n=i===c&&e!==c||i.capture!==e.capture||i.once!==e.once||i.passive!==e.passive,o=i!==c&&(e===c||n);n&&this.element.removeEventListener(this.name,this,e),o&&this.element.addEventListener(this.name,this,i),this._$AH=i}handleEvent(i){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,i):this._$AH.handleEvent(i)}},ie=class{constructor(i,t,e){this.element=i,this.type=6,this._$AN=void 0,this._$AM=t,this.options=e}get _$AU(){return this._$AM._$AU}_$AI(i){J(this,i)}},$i=ne.litHtmlPolyfillSupport;$i?.(wt,yt),(ne.litHtmlVersions??=[]).push("3.3.3");ze=(s,i,t)=>{let e=t?.renderBefore??i,n=e._$litPart$;if(n===void 0){let o=t?.renderBefore??null;e._$litPart$=n=new yt(i.insertBefore(_t(),o),o,void 0,t??{})}return n._$AI(s),n}});var ae,S,ki,Me=k(()=>{ft();ft();tt();tt();ae=globalThis,S=class extends I{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let i=super.createRenderRoot();return this.renderOptions.renderBefore??=i.firstChild,i}update(i){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(i),this._$Do=ze(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return O}};S._$litElement$=!0,S.finalized=!0,ae.litElementHydrateSupport?.({LitElement:S});ki=ae.litElementPolyfillSupport;ki?.({LitElement:S});(ae.litElementVersions??=[]).push("4.2.2")});var Oe=k(()=>{});var C=k(()=>{ft();tt();Me();Oe()});var _,He=k(()=>{_=s=>(i,t)=>{t!==void 0?t.addInitializer(()=>{customElements.define(s,i)}):customElements.define(s,i)}});function y(s){return(i,t)=>typeof t=="object"?Si(s,i,t):((e,n,o)=>{let a=n.hasOwnProperty(o);return n.constructor.createProperty(o,e),a?Object.getOwnPropertyDescriptor(n,o):void 0})(s,i,t)}var Ai,Si,re=k(()=>{ft();Ai={attribute:!0,type:String,converter:mt,reflect:!1,hasChanged:Tt},Si=(s=Ai,i,t)=>{let{kind:e,metadata:n}=t,o=globalThis.litPropertyMetadata.get(n);if(o===void 0&&globalThis.litPropertyMetadata.set(n,o=new Map),e==="setter"&&((s=Object.create(s)).wrapped=!0),o.set(t.name,s),e==="accessor"){let{name:a}=t;return{set(l){let p=i.get.call(this);i.set.call(this,l),this.requestUpdate(a,p,s,!0,l)},init(l){return l!==void 0&&this.C(a,void 0,s,l),l}}}if(e==="setter"){let{name:a}=t;return function(l){let p=this[a];i.call(this,l),this.requestUpdate(a,p,s,!0,l)}}throw Error("Unsupported decorator location: "+e)}});function v(s){return y({...s,state:!0,attribute:!1})}var Pe=k(()=>{re();});var Re=k(()=>{});var K,et=k(()=>{K=(s,i,t)=>(t.configurable=!0,t.enumerable=!0,Reflect.decorate&&typeof i!="object"&&Object.defineProperty(s,i,t),t)});function Ne(s,i){return(t,e,n)=>{let o=a=>a.renderRoot?.querySelector(s)??null;if(i){let{get:a,set:l}=typeof e=="object"?t:n??(()=>{let p=Symbol();return{get(){return this[p]},set(m){this[p]=m}}})();return K(t,e,{get(){let p=a.call(this);return p===void 0&&(p=o(this),(p!==null||this.hasUpdated)&&l.call(this,p)),p}})}return K(t,e,{get(){return o(this)}})}}var Le=k(()=>{et();});var Ie=k(()=>{et();});var De=k(()=>{et();});var je=k(()=>{et();});var Be=k(()=>{et();});var z=k(()=>{He();re();Pe();Re();Le();Ie();De();je();Be()});var qe={};pi(qe,{FaceplateClimateCardEditor:()=>Z});var Ue,Ri,Ni,Li,Ii,Di,Z,le=k(()=>{"use strict";C();z();kt();Ue=["select","input_select"],Ri=["switch","input_boolean","light","select","input_select","number","input_number"],Ni=(s,i)=>[{name:"entity",required:!0,selector:{entity:{domain:"climate"}}},{name:"name",selector:{text:{}}},{name:"layout",selector:{select:{mode:"dropdown",options:[{value:"row",label:"Row (single line)"},{value:"compact",label:"Compact"},{value:"standard",label:"Standard"},{value:"large",label:"Large"}]}}},{name:"current_temperature_entity",selector:{entity:{domain:["sensor","number","input_number"]}}},{name:"outdoor_temperature_entity",selector:{entity:{domain:["sensor","number","input_number"]}}},...i.length?[{name:"default_mode",selector:{select:{mode:"dropdown",options:i.filter(t=>t!=="off").map(t=>({value:t,label:t.replace(/_/g," ").replace(/\b\w/g,e=>e.toUpperCase())}))}}},{name:"hvac_modes",selector:{select:{multiple:!0,mode:"list",options:i.map(t=>({value:t,label:t.replace(/_/g," ").replace(/\b\w/g,e=>e.toUpperCase())}))}}}]:[],{type:"grid",name:"",schema:[{name:"show_name",selector:{boolean:{}}},{name:"show_current_temperature",selector:{boolean:{}}},{name:"show_controls",selector:{boolean:{}}},{name:"show_fan",selector:{boolean:{}}},{name:"show_vertical_swing",selector:{boolean:{}}},{name:"show_horizontal_swing",selector:{boolean:{}}},{name:"show_settings",selector:{boolean:{}}}]},{type:"expandable",title:"Swing entity overrides",icon:"mdi:tune",schema:[{name:"vertical_swing_entity",selector:{entity:{domain:Ue}}},{name:"horizontal_swing_entity",selector:{entity:{domain:Ue}}}]},{type:"expandable",title:"Settings popup",icon:"mdi:tune-variant",schema:[{name:"setting_entities",selector:s?{object:{}}:{entity:{multiple:!0,domain:Ri}}}]},{name:"step",selector:{number:{min:.1,max:5,step:.1,mode:"box"}}}],Li={entity:"Climate entity (required)",name:"Name",layout:"Size / layout",current_temperature_entity:"Current temperature entity (optional)",outdoor_temperature_entity:"Outdoor temperature entity (optional)",hvac_modes:"Modes to offer",default_mode:"Default mode (power button)",show_name:"Show name",show_current_temperature:"Show current temperature",show_controls:"Show buttons",show_fan:"Show fan control",show_vertical_swing:"Show vertical swing",show_horizontal_swing:"Show horizontal swing",show_settings:"Show settings popup",vertical_swing_entity:"Vertical swing entity",horizontal_swing_entity:"Horizontal swing entity",setting_entities:"Entities in settings popup",step:"Temperature step"},Ii={current_temperature_entity:"Overrides the temperature reported by the climate entity",outdoor_temperature_entity:"Shown on the display next to the current temperature",hvac_modes:"Untick modes your unit can't actually do. Empty = offer all of them",show_controls:"Off gives a larger status-only display with no buttons",default_mode:"Pressing power turns the unit on to this mode. Hold the button to pick any mode",vertical_swing_entity:"Use a select entity instead of the climate swing_mode attribute",horizontal_swing_entity:"Use a select entity instead of the climate swing_horizontal_mode attribute",setting_entities:"To rename an item, use YAML: - entity: switch.x, name: Display light",step:"Defaults to the entity's own step"},Di={show_name:!0,show_current_temperature:!0,show_controls:!0,show_fan:!0,show_vertical_swing:!0,show_horizontal_swing:!0,show_settings:!0},Z=class extends S{setConfig(i){this._config=i}render(){if(!this.hass||!this._config)return c;let i=!!this._config.setting_entities?.some(e=>typeof e!="string"),t=this.hass.states[this._config.entity]?.attributes.hvac_modes??[];return r`
      <ha-form
        .hass=${this.hass}
...
`,x=[Ti,Ci,zi,Mi,Oi,Hi,Pi];var Ve={fan:"fan",vswing:"swing",hswing:"h-swing"},R=class extends S{constructor(){super(...arguments);this._popup=null;this._longPressed=!1;this._pressStart=()=>{this._longPressed=!1,window.clearTimeout(this._pressTimer),this._pressTimer=window.setTimeout(()=>{this._longPressed=!0,this._popup="config"},500)};this._pressEnd=()=>{window.clearTimeout(this._pressTimer)};this._powerPress=()=>{if(this._longPressed){this._longPressed=!1;return}if(!this._isOff){this._setHvacMode("off");return}let t=this._defaultMode();t?this._setHvacMode(t):this._popup="config"};this._fanPress=()=>{if(this._longPressed){this._longPressed=!1;return}this._popup="fan"}}static async getConfigElement(){return await Promise.resolve().then(()=>(le(),qe)),document.createElement(xt)}static getStubConfig(t){return{entity:Object.keys(t.states).find(n=>n.startsWith("climate."))??""}}setConfig(t){if(!t.entity||!t.entity.startsWith("climate."))throw new Error("Please define a climate entity");this._config=t}getCardSize(){let t=this._config?.layout;return t==="row"?1:t==="compact"?2:3}getGridOptions(){return this._config?.layout==="row"?{columns:12,rows:1,min_columns:6,min_rows:1}:{columns:6,rows:3,min_columns:3,min_rows:2}}disconnectedCallback(){super.disconnectedCallback(),window.clearTimeout(this._commitTimer),window.clearTimeout(this._pressTimer)}get _stateObj(){return this._config&&this.hass?this.hass.states[this._config.entity]:void 0}_show(t){return this._config?.[t]!==!1}_selectSource(t){let e=this.hass?.states[t];if(!e)return;let o=t.split(".")[0]==="input_select"?"input_select":"select";return{options:e.attributes.options??[],current:e.state,set:a=>this.hass.callService(o,"select_option",{entity_id:t,option:a})}}_climateSource(t,e,n){let o=this._stateObj;if(o?.attributes[t]?.length)return{options:o.attributes[t],current:o.attributes[e],set:a=>this.hass.callService("climate",n,{entity_id:o.entity_id,[e]:a})}}_fanSections(){let t=[];if(this._show("show_fan")){let n=this._climateSource("fan_modes","fan_mode","set_fan_mode");n&&t.push({key:"fan",title:"Fan speed",segmentIcon:Vt(n.current??""),icon:Vt,source:n})}let e=this._show("show_horizontal_swing")?this._config?.horizontal_swing_entity?this._selectSource(this._config.horizontal_swing_entity):this._climateSource("swing_horizontal_modes","swing_horizontal_mode","set_swing_horizontal_mode"):void 0;if(this._show("show_vertical_swing")){let n=this._config?.vertical_swing_entity?this._selectSource(this._config.vertical_swing_entity):this._climateSource("swing_modes","swing_mode","set_swing_mode");if(n?.options.length){let o=!e?.options.length&&n.options.some(l=>/horiz|both/i.test(l)),a=o?ue:l=>$t(l,!1);t.push({key:"vswing",title:o?"Swing":"Vertical swing",segmentIcon:a(n.current??""),icon:a,source:n})}}return e?.options.length&&t.push({key:"hswing",title:"Horizontal swing",segmentIcon:$t(e.current??"",!0),icon:n=>$t(n,!0),source:e}),t}_hasSettings(){return this._show("show_settings")?!!(this._stateObj?.attributes.preset_modes?.length||this._config?.setting_entities?.length):!1}get _isOff(){return this._stateObj?.state==="off"}get _step(){return this._config?.step??this._stateObj?.attributes.target_temp_step??.5}get _targetTemp(){return this._localTarget??this._stateObj?.attributes.temperature}get _currentTemp(){let t=this._config?.current_temperature_entity;if(t){let e=this.hass?.states[t],n=e?parseFloat(e.state):NaN;return Number.isFinite(n)?n:void 0}return this._stateObj?.attributes.current_temperature}get _outdoorTemp(){let t=this._config?.outdoor_temperature_entity;if(!t)return;let e=this.hass?.states[t],n=e?parseFloat(e.state):NaN;return Number.isFinite(n)?n:void 0}get _unit(){return this.hass?.config.unit_system.temperature??"\xB0C"}_modeName(t){return this.hass?.localize(`component.climate.entity_component._.state.${t}`)||P(t)}willUpdate(){this._localTarget!==void 0&&this._stateObj?.attributes.temperature===this._localTarget&&(this._localTarget=void 0)}_adjustTemp(t){let e=this._stateObj;if(!e)return;let n=e.attributes,o=this._targetTemp??n.min_temp??20,a=n.min_temp??7,l=n.max_temp??35,p=this._step,m=Math.min(l,Math.max(a,o+t*p)),h=`${p}`.split(".")[1]?.length??0;this._localTarget=parseFloat(m.toFixed(h)),window.clearTimeout(this._commitTimer),this._commitTimer=window.setTimeout(()=>{this.hass.callService("climate","set_temperature",{entity_id:e.entity_id,temperature:this._localTarget})},700)}_availableModes(){let t=this._config?.hvac_modes;return[...this._stateObj?.attributes.hvac_modes??[]].filter(e=>!t?.length||t.includes(e)).sort((e,n)=>qt.indexOf(e)-qt.indexOf(n))}_defaultMode(){let t=this._availableModes().filter(n=>n!=="off"),e=this._config?.default_mode;return e&&t.includes(e)?e:t.length===1?t[0]:void 0}_setHvacMode(t){this.hass.callService("climate","set_hvac_mode",{entity_id:this._config.entity,hvac_mode:t})}render(){if(!this._config||!this.hass)return c;let t=this._stateObj;if(!t)return r`<ha-card class="error">
        ...
        >
          ...
          ${a.length||h?r`<div class="lcd-status">
                ${a.map(w=>r`<button
                  ...
                  >
                    <span class="seg-label">${Ve[w.key]??w.key}</span>
                    <span
                      >${b?"\u2014":Gt(w.source.current??"\u2014")||"\u2014"}</span
                    >
                  </button>`)}
    ...
    `}_formatNumber(t){return t.toLocaleString(this.hass?.language??"en",{maximumFractionDigits:1})}_renderPopup(t){if(!this._popup)return c;let e=()=>this._popup=null;if(this._popup==="fan"){let h=t.find(u=>u.key==="fan");return h?r`
        <dialog class="popup-backdrop" @click=${e} @close=${e}>
          ...
          >
            ...
            <div class="popup-body">
              <div class="chips">
                ${h.source.options.map(u=>{let b=Wt(u);return r`<button
                    class=${f({chip:!0,"chip-icon":b!==null,active:u===h.source.current})}
                    title=${P(u)}
                    @click=${()=>{h.source.set(u),e()}}
                  >
                    ${this._renderFanChipIcon(u,h.icon(u),b)}
                    ${b===null?P(u):c}
                  </button>`})}
              </div>
            </div>
      ...
      `:c}let n=this._stateObj,o=n.state==="unavailable",a=this._config?.name??n.attributes.friendly_name??"Settings",l=X[n.state]??X.off,p=this._isOff||o,m=r`
      ...
      <div class="popup-lcd ${p?"off":""}">
        ...
        <div class="popup-lcd-center">
          ...
          <span class=${f({"temp-value":!0,dimmed:p})}>
        ...
        ${t.length?r`<div class="lcd-status">
              ${t.map(h=>r`<span class="segment">
                  ...
                  <span>${p?"\u2014":Gt(h.source.current??"\u2014")||"\u2014"}</span>
                </span>`)}
            </div>`:c}
      </div>
      ...
      ${t.map(h=>r`
          ...
          <div class="chips">
            ${h.source.options.map(u=>{let b=h.key==="fan"?Wt(u):null;return r`<button
                class=${f({chip:!0,"chip-icon":b!==null,active:u===h.source.current})}
                title=${P(u)}
                @click=${()=>h.source.set(u)}
              >
                ${this._renderFanChipIcon(u,h.icon(u),b)}
                ${b===null?P(u):c}
              </button>`})}
    ...
    `}_renderSettingRow(t){let e=typeof t=="string"?t:t.entity,n=typeof t=="string"?void 0:t.name,o=this.hass.states[e];if(!o)return r`<div class="row">
        ...
        ></ha-switch>
      </div>`;if(["select","input_select"].includes(a)){let p=a==="input_select"?"input_select":"select",m=o.attributes.options??[];return r`<div class="row column">
        <span class="row-name">${l}</span>
        <div class="chips">
          ${m.map(h=>r`<button
              class=${f({chip:!0,active:h===o.state})}
              @click=${()=>this.hass.callService(p,"select_option",{entity_id:e,option:h})}
            >
              ${P(h)}
            </button>`)}
        </div>
      </div>`}if(["number","input_number"].includes(a)){let p=a==="input_number"?"input_number":"number",m=parseFloat(o.state),h=o.attributes.step??1,u=b=>this.hass.callService(p,"set_value",{entity_id:e,value:Math.min(o.attributes.max??1/0,Math.max(o.attributes.min??-1/0,b))});return r`<div class="row">
        <span class="row-name">${l}</span>
        <div class="stepper">
          <button class="ctl mini" @click=${()=>u(m-h)}>
            <ha-icon icon="mdi:minus"></ha-icon>
          </button>
    ...
    `],d([y({attribute:!1})],R.prototype,"hass",2),d([v()],R.prototype,"_config",2),d([v()],R.prototype,"_popup",2),d([Ne("dialog.popup-backdrop")],R.prototype,"_dialogEl",2),d([v()],R.prototype,"_localTarget",2),R=d([_(vt)],R);le();C();z();C();z();var $=class extends S{static{this.styles=x}static{this.requiresEntity=!0}setConfig(i){let t=this.constructor;if(t.requiresEntity){let e=t.entityDomains,n=i.entity?.split(".")[0];if(!i.entity||e&&!e.includes(n))throw new Error(e?`Please define a ${e.join(" or ")} entity`:"Please define an entity")}this._config=i}getCardSize(){return 2}get _stateObj(){return this._config?.entity&&this.hass?this.hass.states[this._config.entity]:void 0}_show(i){return this._config?.[i]!==!1}_missingEntity(){return r`<ha-card class="error">
      Entity not found: ${this._config?.entity}
    </ha-card>`}_guard(){if(!this._config||!this.hass)return c;let i=this.constructor,t=!!this._config.entity;return!this._stateObj&&(i.requiresEntity||t)?this._missingEntity():null}};d([y({attribute:!1})],$.prototype,"hass",2),d([v()],$.prototype,"_config",2);C();z();var E=class extends S{constructor(){super(...arguments);this.labels={};this.helpers={};this.defaults={}}setConfig(t){this._config=t}render(){return!this.hass||!this._config?c:r`
      <ha-form
        .hass=${this.hass}
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `}_valueChanged(t){t.stopPropagation();let e={...t.detail.value};for(let[n,o]of Object.entries(e))(o===""||Array.isArray(o)&&o.length===0)&&delete e[n];this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}))}};d([y({attribute:!1})],E.prototype,"hass",2),d([v()],E.prototype,"_config",2);var We={type:"expandable",title:"Actions",icon:"mdi:gesture-tap",schema:[{name:"tap_action",selector:{ui_action:{}}},{name:"hold_action",selector:{ui_action:{}}},{name:"double_tap_action",selector:{ui_action:{}}}]},Ot={tap_action:"Tap action",hold_action:"Hold action",double_tap_action:"Double tap action"};var ji={lock:"lock",cover:"cover",group:"homeassistant"};function ce(s,i,t){s.dispatchEvent(new CustomEvent(i,{detail:t,bubbles:!0,composed:!0}))}function D(s,i){ce(s,"hass-more-info",{entityId:i})}function j(s,i,t,e){let n=`${e}_action`,o=e==="tap"?{action:t.entity?"toggle":"none"}:e==="hold"?{action:t.entity?"more-info":"none"}:{action:"none"},a=t[n]??o;switch(a.action){case"none":return;case"more-info":{let l=a.entity??t.entity;l&&D(s,l);return}case"toggle":{let l=a.entity??t.entity;if(!l)return;let p=l.split(".")[0];i.callService(ji[p]??"homeassistant","toggle",{entity_id:l});return}case"navigate":{if(!a.navigation_path)return;if(a.navigation_path==="back"){history.back();return}history.pushState(null,"",a.navigation_path),ce(s,"location-changed",{replace:!1});return}case"url":{a.url_path&&window.open(a.url_path,"_blank","noreferrer");return}case"assist":ce(s,"show-dialog",{dialogTag:"ha-voice-command-dialog",dialogImport:()=>Promise.resolve(),dialogParams:{}});return;case"call-service":case"perform-action":{let l=a.perform_action??a.service;if(!l||!l.includes("."))return;let[p,m]=l.split(".",2);i.callService(p,m,a.data??a.service_data??{},a.target);return}}}var nt=class{constructor(i,t={}){this._run=i;this._opts=t;this._held=!1;this._lastTap=0;this.down=()=>{this._held=!1,this._opts.hasHold&&(window.clearTimeout(this._timer),this._timer=window.setTimeout(()=>{this._held=!0,this._run("hold")},this._opts.holdMs??500))};this.up=()=>{window.clearTimeout(this._timer)};this.click=i=>{if(i.stopPropagation(),this._held){this._held=!1;return}if(!this._opts.hasDoubleTap){this._run("tap");return}let t=Date.now();if(t-this._lastTap<300){window.clearTimeout(this._tapTimer),this._lastTap=0,this._run("double_tap");return}this._lastTap=t,this._tapTimer=window.setTimeout(()=>this._run("tap"),300)}}destroy(){window.clearTimeout(this._timer),window.clearTimeout(this._tapTimer)}};function pe(s){return s.replace(/[_-]+/g," ").replace(/\b\w/g,i=>i.toUpperCase())}function H(s,i,t=1){return i.toLocaleString(s?.language??"en",{maximumFractionDigits:t})}function Ht(s,i){if(!i)return"";if(s?.formatEntityState)try{return s.formatEntityState(i)}catch{}let t=i.entity_id.split(".")[0];return s?.localize(`component.${t}.entity_component._.state.${i.state}`)||pe(i.state)}function N(s,i){return i??s?.attributes.friendly_name??s?.entity_id??""}var Ge="faceplate-button-card",Ke="faceplate-button-card-editor",ot=class extends ${static async getConfigElement(){return document.createElement(Ke)}static getStubConfig(){return{show_name:!0,show_icon:!0,tap_action:{action:"toggle"}}}getCardSize(){return 1}getGridOptions(){return{columns:4,rows:1,min_columns:2,min_rows:1}}setConfig(i){super.setConfig(i),this._handler?.destroy(),this._handler=new nt(t=>this._run(t),{hasHold:!!i.hold_action||!!i.entity,hasDoubleTap:!!i.double_tap_action})}disconnectedCallback(){super.disconnectedCallback(),this._handler?.destroy()}_run(i){this.hass&&this._config&&j(this,this.hass,this._config,i)}render(){let i=this._guard();if(i!==null)return i;let t=this._config,e=this._stateObj,n=e?.state==="on"||e?.state==="open",o=e?.state==="unavailable",a=N(e,t.name),l=t.icon??e?.attributes.icon??this._domainIcon(n),p=t.show_name!==!1&&!!a,m=!!(t.show_state&&e);return r`
      <ha-card
        class=${f({unavailable:o,"with-name":p,"with-state":m})}
      >
        ${t.show_icon===!1?c:r`<button
        ...
        ${p?r`<span class="label" title=${a}>${a}</span>`:c}
        ${m?r`<span class="label state"
              >${Ht(this.hass,e)}</span
            >`:c}
      </ha-card>
    ...
    `],ot=d([_(Ge)],ot);var Pt=class extends E{constructor(){super(...arguments);this.defaults={show_name:!0,show_icon:!0,show_state:!1};this.labels={entity:"Entity (optional)",name:"Name",icon:"Icon",show_name:"Show name",show_icon:"Show icon",show_state:"Show state",accent:"Accent colour",icon_badge:"Icon badge",...Ot};this.helpers={entity:"Leave empty for a button that only navigates or runs an action",accent:"Fill the button with the theme's accent colour at all times",icon_badge:"A digit or two set into the icon's corner, like a numbered fan speed"}}schema(t,e){return[{name:"entity",selector:{entity:{}}},{name:"name",selector:{text:{}}},{name:"icon",selector:{icon:{}}},{name:"icon_badge",selector:{text:{}}},{type:"grid",name:"",schema:[{name:"show_name",selector:{boolean:{}}},{name:"show_icon",selector:{boolean:{}}},{name:"show_state",selector:{boolean:{}}},{name:"accent",selector:{boolean:{}}}]},We]}};Pt=d([_(Ke)],Pt);A({type:Ge,name:"Faceplate Button",description:"A round tactile button that fills its tile \u2014 toggles, scripts, scenes and navigation"});C();z();var Ze="faceplate-tile-card",Ye="faceplate-tile-card-editor",st=class extends ${constructor(){super(...arguments);this._iconTap=t=>{if(t.stopPropagation(),!this.hass||!this._config)return;let e=this._config.icon_tap_action;if(e){j(this,this.hass,{...this._config,tap_action:e},"tap");return}if(!this._config.entity){j(this,this.hass,this._config,"tap");return}let n=this._config.entity.split(".")[0];if(["script","scene","button","input_button"].includes(n)){let o=n==="script"||n==="scene"?"turn_on":"press";this.hass.callService(n,o,{entity_id:this._config.entity});return}if(["light","switch","fan","input_boolean","media_player"].includes(n)){this.hass.callService("homeassistant","toggle",{entity_id:this._config.entity});return}D(this,this._config.entity)}}static async getConfigElement(){return document.createElement(Ye)}static getStubConfig(t){return{entity:Object.keys(t.states).find(n=>n.startsWith("light."))??Object.keys(t.states)[0]??""}}getCardSize(){return 1}getGridOptions(){return this._config?.vertical?{columns:3,rows:2,min_columns:2,min_rows:2}:{columns:6,rows:1,min_columns:3,min_rows:1}}setConfig(t){super.setConfig(t),this._rowHandler?.destroy(),this._rowHandler=new nt(e=>this._run(e),{hasHold:!0,hasDoubleTap:!!t.double_tap_action})}disconnectedCallback(){super.disconnectedCallback(),this._rowHandler?.destroy()}_run(t){if(!this.hass||!this._config)return;let e=t==="tap"&&!this._config.tap_action?{...this._config,tap_action:{action:"more-info"}}:this._config;j(this,this.hass,e,t)}render(){let t=this._guard();if(t!==null)return t;let e=this._config,n=this._stateObj,o=n?["on","open","playing","home"].includes(n.state):!1,a=n?.state==="unavailable",l=N(n,e.name),p=e.icon??n?.attributes.icon??"mdi:eye";return r`
      <ha-card
    ...
    `}};st.requiresEntity=!1,st.styles=[...x,g`
      ha-card {
        flex-direction: row;
        align-items: center;
        justify-content: flex-start;
    ...
    `],st=d([_(Ze)],st);var Rt=class extends E{constructor(){super(...arguments);this.defaults={show_state:!0,vertical:!1};this.labels={entity:"Entity (required)",name:"Name",icon:"Icon",show_state:"Show state",vertical:"Vertical layout",accent:"Accent colour",icon_tap_action:"Icon tap action",...Ot};this.helpers={icon_tap_action:"Defaults to toggling, or running the script/scene. The rest of the row opens more-info"}}schema(){return[{name:"entity",required:!0,selector:{entity:{}}},{name:"name",selector:{text:{}}},{name:"icon",selector:{icon:{}}},{type:"grid",name:"",schema:[{name:"show_state",selector:{boolean:{}}},{name:"vertical",selector:{boolean:{}}},{name:"accent",selector:{boolean:{}}}]},{type:"expandable",title:"Actions",icon:"mdi:gesture-tap",schema:[{name:"icon_tap_action",selector:{ui_action:{}}},{name:"tap_action",selector:{ui_action:{}}},{name:"hold_action",selector:{ui_action:{}}},{name:"double_tap_action",selector:{ui_action:{}}}]}]}};Rt=d([_(Ye)],Rt);A({type:Ze,name:"Faceplate Tile",description:"An entity row with a tactile icon button, its name and its state in LCD type"});C();z();C();z();var T=class extends S{constructor(){super(...arguments);this.value=0;this.min=0;this.max=100;this.step=1;this.disabled=!1;this.unit="";this.hideValue=!1;this._down=t=>{this.disabled||(t.preventDefault(),this._pointerId=t.pointerId,t.target.setPointerCapture(t.pointerId),this._dragValue=this._valueFromEvent(t))};this._move=t=>{this.disabled||this._pointerId!==t.pointerId||(this._dragValue=this._valueFromEvent(t))};this._up=t=>{if(this.disabled||this._pointerId!==t.pointerId)return;let e=this._valueFromEvent(t);this._pointerId=void 0,this._dragValue=void 0,this.value=e,this.dispatchEvent(new CustomEvent("slider-change",{detail:{value:e},bubbles:!0,composed:!0}))};this._cancel=()=>{this._pointerId=void 0,this._dragValue=void 0}}get _shown(){return this._dragValue??this.value}_valueFromEvent(t){let e=this.renderRoot.querySelector(".track").getBoundingClientRect(),n=Math.min(1,Math.max(0,(t.clientX-e.left)/e.width)),o=this.min+n*(this.max-this.min),a=Math.round(o/this.step)*this.step;return Math.min(this.max,Math.max(this.min,a))}render(){let t=this.max-this.min||1,n=`${(Math.min(1,Math.max(0,(this._shown-this.min)/t))*100).toFixed(1)}%`;return r`
      ...
      >
        ...
        <div class="content">
          ...
          ${this.hideValue?c:r`<span class="value"
  ...
  `,d([y({type:Number})],T.prototype,"value",2),d([y({type:Number})],T.prototype,"min",2),d([y({type:Number})],T.prototype,"max",2),d([y({type:Number})],T.prototype,"step",2),d([y({type:Boolean})],T.prototype,"disabled",2),d([y({type:String})],T.prototype,"label",2),d([y({type:String})],T.prototype,"unit",2),d([y({type:String})],T.prototype,"fill",2),d([y({type:String})],T.prototype,"gradient",2),d([y({type:Boolean,attribute:"hide-value"})],T.prototype,"hideValue",2),d([v()],T.prototype,"_dragValue",2),T=d([_("faceplate-slider")],T);var Xe="faceplate-light-card",Je="faceplate-light-card-editor",Bi=2e3,Fi=6535,at=class extends ${constructor(){super(...arguments);this._toggle=()=>{this.hass.callService("light","toggle",{entity_id:this._config.entity})};this._setBrightness=t=>{let{min:e,max:n}=this._brightnessRange;this.hass.callService("light","turn_on",{entity_id:this._config.entity,brightness_pct:e+(n-e)*t.detail.value/100})};this._setColorTemp=t=>{this.hass.callService("light","turn_on",{entity_id:this._config.entity,color_temp_kelvin:Math.round(t.detail.value)})}}static async getConfigElement(){return document.createElement(Je)}static getStubConfig(t){return{entity:Object.keys(t.states).find(n=>n.startsWith("light."))??"",show_brightness_control:!0}}getCardSize(){return 2}getGridOptions(){let t=this._config?.show_color_temp_control?4:3;this._config?.show_state===!1&&(t-=1),this._config?.show_controls===!1&&(t-=1);let e=this._config?.show_state===!1&&this._config?.show_controls===!1;return{columns:6,rows:Math.max(1,t),min_columns:3,min_rows:e?1:2}}get _on(){return this._stateObj?.state==="on"}get _brightnessRange(){let t=o=>typeof o=="number"&&o>=0&&o<=100?o:void 0,e=t(this._config?.min_brightness)??0,n=t(this._config?.max_brightness)??100;return n>e?{min:e,max:n}:{min:0,max:100}}get _brightness(){let t=this._stateObj?.attributes.brightness;if(typeof t!="number")return;let{min:e,max:n}=this._brightnessRange,o=t/255*100;return Math.min(100,Math.max(0,Math.round((o-e)/(n-e)*100)))}get _kelvinRange(){let t=this._stateObj?.attributes.min_color_temp_kelvin??Bi,e=this._stateObj?.attributes.max_color_temp_kelvin??Fi,n=this._config?.min_color_temp_kelvin,o=this._config?.max_color_temp_kelvin,a=typeof n=="number"?Math.max(t,n):t,l=typeof o=="number"?Math.min(e,o):e;return l>a?{min:a,max:l}:{min:t,max:e}}get _supportsBrightness(){return(this._stateObj?.attributes.supported_color_modes??[]).some(e=>e!=="onoff"&&e!=="unknown")}get _supportsColorTemp(){return(this._stateObj?.attributes.supported_color_modes??[]).includes("color_temp")}get _lightColor(){if(this._config?.use_light_color===!1||!this._on)return;let t=this._stateObj?.attributes.rgb_color;if(Array.isArray(t)&&t.length>=3)return`rgb(${t[0]}, ${t[1]}, ${t[2]})`;let e=this._stateObj?.attributes.color_temp_kelvin;if(typeof e=="number")return Nt(e)}render(){let t=this._guard();if(t!==null)return t;let e=this._config,n=this._stateObj,o=n.state==="unavailable",a=N(n,e.name),l=this._lightColor,p=this._brightness,m=e.icon??n.attributes.icon??(this._on?"mdi:lightbulb":"mdi:lightbulb-outline"),h=e.show_state===!1&&e.show_controls===!1,u=e.show_brightness_control!==!1&&this._supportsBrightness&&!o,b=e.show_color_temp_control===!0&&this._supportsColorTemp&&!o,{min:w,max:L}=this._kelvinRange,li=Math.min(L,Math.max(w,n.attributes.color_temp_kelvin??w));return r`
      <ha-card class=${f({strip:h})}>
        <div class=${f({lcd:!0,off:!this._on})}>
          <div class="lcd-top">
            ...
            ${this._show("show_toggle")?r`<button
              ...
              @click=${this._toggle}
                >
                  <ha-icon class="bulb" icon=${m}></ha-icon>
                </button>`:c}
          </div>
          ${this._show("show_state")?r`<div class="lcd-center">
                ${o?r`<span class="off-label">Unavailable</span>`:this._on?p===void 0?r`<span class="readout">On</span>`:r`<span class="readout"
                          >${p}<span class="unit">%</span></span
                        >`:r`<span class="off-label">Off</span>`}
              </div>`:c}
        </div>

        ${u||b?r`<div class="sliders">
              ${u?r`<faceplate-slider
              ...
              ${b?r`<faceplate-slider
                    ...
                    .value=${li}
                    .disabled=${!this._on}
                    .gradient=${`linear-gradient(to right, ${Nt(w)}, ${Nt((w+L)/2)}, ${Nt(L)})`}
        ...
        ${this._show("show_controls")?r`<div class="controls">
              ...
              <button
                class="ctl"
                title="Details"
                @click=${()=>D(this,e.entity)}
              >
                <ha-icon icon="mdi:dots-horizontal"></ha-icon>
              </button>
            </div>`:c}
      </ha-card>
    `}};at.entityDomains=["light"],at.styles=[...x,g`
    ...
    `}_weather(){if(!this._weatherWanted)return;let t=this.hass?.states[this._config.weather_entity];if(!t)return;let e=this._forecast[0],n=e?.condition??t.state,o=e?.temperature,a=e?.templow,l=t.attributes?.temperature;return r`<span class="weather">
      ...
      ${l===void 0?c:r`<span class="temp-now"
            >${H(this.hass,l,0)}°</span
          >`}
      <span class="temps">
        ${o===void 0?"--":H(this.hass,o,0)}°${a===void 0?c:r`<span class="temp-low"
              >/${H(this.hass,a,0)}°</span
            >`}
      </span>
    </span>`}};F.requiresEntity=!1,F.styles=[...x,g`
      ...
      <ha-card @click=${()=>D(this,e.entity)}>
        <div class="lcd ${e.show_current===!1?"no-current":""}">
          ${e.show_current===!1?c:r`
              ...
              `}
          ${m.length?r`<div class="forecast">
                ${m.map(h=>r`<div class="slot">
                    <span class="slot-label">${this._slotLabel(h)}</span>
                    <ha-icon icon=${this._icon(h.condition)}></ha-icon>
                    <span class="slot-temps">
                      ${h.temperature===void 0?"--":H(this.hass,h.temperature,0)}°${h.templow===void 0?c:r`<span class="slot-low"
    ...
    `}};lt.requiresEntity=!1,lt.styles=[...x,g`
  ...
  `,d([y({attribute:!1})],q.prototype,"hass",2),d([v()],q.prototype,"_config",2),d([v()],q.prototype,"_selected",2),q=d([_(si)],q);var qi=[{name:"entity",selector:{entity:{}}},{name:"name",selector:{text:{}}},{name:"icon",selector:{icon:{}}},{type:"grid",name:"",schema:[{name:"label",selector:{text:{}}},{name:"caption",selector:{text:{}}},{name:"icon_badge",selector:{text:{}}},{name:"danger",selector:{boolean:{}}}]},{name:"tap_action",selector:{ui_action:{}}},{name:"hold_action",selector:{ui_action:{}}}],Vi={entity:"Entity (optional \u2014 colours the button when on)",name:"Name",icon:"Icon",label:"Text label",caption:"Caption under icon",icon_badge:"Icon badge",danger:"Mark out (action colour)",tap_action:"Tap action",hold_action:"Hold action"},Wi={label:"Replaces the icon with mono text \u2014 a fan speed reads faster as 3",caption:"Small text under the icon, like OFF under a ceiling fan",danger:"The one member of a set that undoes the others"};A({type:Ft,name:"Faceplate Buttons",description:"A row of buttons that stays on one line, for sets that do not divide into the grid's twelve columns"});C();z();var ai="faceplate-media-card",ri="faceplate-media-card-editor",ct={PAUSE:1,VOLUME_SET:4,VOLUME_MUTE:8,PREVIOUS_TRACK:16,NEXT_TRACK:32,TURN_ON:128,TURN_OFF:256,STOP:4096,PLAY:16384},pt=class extends ${constructor(){super(...arguments);this._playPause=()=>this._call("media_play_pause");this._next=()=>this._call("media_next_track");this._previous=()=>this._call("media_previous_track");this._toggleMute=()=>this._call("volume_mute",{is_volume_muted:!this._muted});this._setVolume=t=>{this._call("volume_set",{volume_level:t.detail.value*this._maxVolume/1e4})}}static async getConfigElement(){return document.createElement(ri)}static getStubConfig(t){return{entity:Object.keys(t.states).find(n=>n.startsWith("media_player."))??"",show_art:!0}}getCardSize(){return 3}getGridOptions(){let t=3;return this._config?.show_volume_control===!1&&(t-=1),this._config?.show_controls===!1&&(t-=1),{columns:12,rows:Math.max(1,t),min_columns:4,min_rows:1}}get _playing(){return this._stateObj?.state==="playing"}_supports(t){return((this._stateObj?.attributes.supported_features??0)&t)!==0}get _maxVolume(){let t=this._config?.max_volume;return typeof t=="number"&&t>0&&t<=100?t:100}get _volume(){let t=this._stateObj?.attributes.volume_level;return typeof t!="number"?0:Math.min(100,Math.round(t*100/this._maxVolume*100))}get _muted(){return this._stateObj?.attributes.is_volume_muted===!0}_call(t,e={}){this.hass.callService("media_player",t,{entity_id:this._config.entity,...e})}render(){let t=this._guard();if(t!==null)return t;let e=this._config,n=this._stateObj,o=n.state==="unavailable",a=n.state==="off"||n.state==="standby",l=N(n,e.name),p=n.attributes.media_title,m=n.attributes.media_artist??n.attributes.media_album_name,h=n.attributes.entity_picture,u=e.show_volume_control!==!1&&this._supports(ct.VOLUME_SET)&&!o,b=e.show_controls!==!1&&!o;return r`
      <ha-card>
        <div class=${f({lcd:!0,off:a||o})}>
          ...
          ${this._show("show_state")?r`<div class="now">
                ${o?r`<span class="idle">Unavailable</span>`:p?r`
                        ${e.show_art!==!1&&h?r`<img class="art" src=${h} alt="" />`:c}
                        <div class="lines">
                          <span class="title" title=${p}>${p}</span>
                          ${m?r`<span class="artist" title=${m}
                                >${m}</span
                              >`:c}
                        </div>
    ...
    `}};pt.entityDomains=["media_player"],pt.styles=[...x,g`
      ha-card {
        container-type: inline-size;
